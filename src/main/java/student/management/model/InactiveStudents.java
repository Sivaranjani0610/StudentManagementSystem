...
public class InactiveStudents {
	...
	public InactiveStudents(String firstname,String surname,int year,String dateofbirth,String schoolname,String guardianname,String guardianno,String address) {
		super();
